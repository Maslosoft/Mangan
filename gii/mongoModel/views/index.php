...
<?php $form=$this->beginWidget('CCodeForm', ['model'=>$model]); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tableName', ['size'=>65]); ?>
		<div class="tooltip">
	...
	<div class="row model-class">
		<?php echo $form->label($model,'mongoCollectionName',['required'=>true]); ?>
		<?php echo $form->textField($model,'mongoCollectionName', ['size'=>65]); ?>
		<div class="tooltip">
