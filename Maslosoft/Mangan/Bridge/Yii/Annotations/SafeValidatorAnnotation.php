 ...
 * This is not actual validator. For validator class @see CSafeValidator.
 */
 ...
 * @since 1.1
 */
class SafeValidatorAnnotation extends ValidatorAnnotation implements IBuiltInValidatorAnnotation
{
